...
<head>
    ...
    <!--  Favicon -->
    <link rel="shortcut icon" type="image/png" href="{{ asset('images/logo.webp') }}" />
    <!-- Owl Carousel -->
            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="{{ route('admin.dashboard') }}" class="text-nowrap logo-img">
                        <img src="{{ asset('images/logo.webp') }}" class="dark-logo" width="30" alt="" />
                        <img src="{{ asset('images/logo.webp') }}" class="light-logo" width="30" alt="" />
                    </a>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar>
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="{{ route('admin.message') }}"
                                aria-expanded="false">
                                <span class="rounded-3">
                                    <i class="ti ti-home"></i>
                                </span>
    ...
    <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="mobilenavbar"
        ...
        <nav class="sidebar-nav scroll-sidebar">
            <div class="offcanvas-header justify-content-between">
                <img src="../../dist/images/logos/faviacon.ico" alt="" class="img-fluid">
