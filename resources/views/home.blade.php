...
<section class="relative h-screen min-h-[600px] flex items-center overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        <img class="hero-image" src="{{ asset('images/hero/hero-bg-1.webp') }}" alt="Peachblossoms School Students"
            ...
            <div class="card group overflow-hidden">
                <div class="relative h-64 overflow-hidden">
                    <img src="{{ asset('images/building/peachblossoms_kindergarten.webp') }}"
                        alt="Peachblossoms Kindergarten School Building"
            ...
            <div class="card group overflow-hidden">
                <div class="relative h-64 overflow-hidden">
                    <img src="{{ asset('images/building/peachblossoms_primary.webp') }}"
                        alt="Peachblossoms Primary School Building"
                        class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
                        onerror="
            ...
            <div class="card group overflow-hidden">
                <div class="relative h-64 overflow-hidden">
                    <img src="{{ asset('images/building/peachblossoms_high_school.webp') }}"
                        alt="Peachblossoms High School Building"
                        class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
                            ...
                            <div class="flex flex-col md:flex-row items-center gap-8">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('images/testimonials/' . $testimony->photo) }}"
                                        alt="Testimoni Orangtua di Peachblososms School"
                                ...
                                <div class="flex-1 text-center md:text-left">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-text-secondary">Parent of
                                            {{ $testimony->student_name . ' - ' . $testimony->class }}
                                        </p>
                                    </div>
                                </div>
                            </div>
